...
if __name__ == '__main__':
    ...
    # 加载数据位置
    root_dir = '../../Datas/vectors/Lee/diagall2'
    data_info_path = os.path.join(root_dir, 'data_info.json')

    # 模型保存文件
    model_dir = '../../models/Lee/diagall2'
    ...
    train_datasets = make_datasets(network=network_zip, ngenes=ngenes, root_dir=root_dir, is_X=is_X, update_mask=update_mask)
    ...
    print('root_dir={}\nload_epochs={}\nsave_epochs={}\nbatch_size={}\nlr={}\nupdate_mask={}'.format(root_dir, load_epochs, save_epochs, batch_size, lr, update_mask))
